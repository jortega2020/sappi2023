...
export const CardWidgetProjectApprovedIcon = IoIosCheckmarkCircle; // Card Achievement icon
...
// Project Icons
export const SettingIcon = IoIosSettings;
export const ProjectsIcon = IoIosBriefcase;