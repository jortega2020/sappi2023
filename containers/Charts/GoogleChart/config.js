...
const BarChart = {
  ...
  options: {
    title: 'Estadísticas de visitantes de 2010 a 2016',
    titleTextStyle: {
      color: '#788195',
    },
    bar: {
...
const BubbleChart = {
  ...
  height,
  data: [
    ['ID', 'Esperanza de vida', 'Tasa de fertilidad', 'Region', 'Población'],
    ['CAN', 80.66, 1.67, 'América del norte', 33739900],
    ['DEU', 79.84, 1.36, 'Europa', 81902307],
    ['DNK', 78.6, 1.84, 'Europa', 5523095],
    ['EGY', 72.73, 2.78, 'Medio Oriente', 79716203],
    ['GBR', 80.05, 2, 'Europa', 61801570],
    ['IRN', 72.49, 1.7, 'Medio Oriente', 73137148],
    ['IRQ', 68.09, 4.77, 'Medio Oriente', 31090763],
    ['ISR', 81.55, 2.96, 'Medio Oriente', 7485600],
    ['RUS', 68.6, 1.54, 'Europa', 141850000],
    ['USA', 78.09, 2.05, 'América del norte', 307007000],
  ],
  options: {
    title:
      'Correlación entre esperanza de vida, tasa de fertilidad y población de algunos países del mundo (2010)',
    titleTextStyle: {
      color: '#788195',
    },
    legend: {
...
const SteppedAreaChart = {
  title: 'Gráfico de área escalonada',
