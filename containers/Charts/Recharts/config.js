...
const becasData = [
  {name:'ÁREA CENTRAL',Becas:20,Becas2:20},
  {name:'CEBIOGEN',Becas:42,Becas2:42},
  {name:'CECYT NO. 01',Becas:7,Becas2:7},
  {name:'CECYT NO. 02',Becas:40,Becas2:40},
  {name:'CECYT NO. 03',Becas:10,Becas2:10},
  {name:'CECYT NO. 04',Becas:1,Becas2:1},
  
];
const SimpleLineCharts = {
  componentName: 'SimpleLineCharts',
  key: 'SimpleLineCharts',
  title: 'Gráfica de líneas simples',
  width,
  height,
  colors,
  datas,
...
const CustomizedDotLineChart = {
  ...
  title: 'Gráfica de líneas de puntos personalizado',
  width,
  height,
  colors,
  datas: [
...
const BecasSimpleBarChart = {
  componentName: 'SimpleBarChart',
  key: 'SimpleBarChart',
  title: 'Becas por adscripcion del proyecto 2',
  width,
  height,
  colors,
  becasData,
...
const MixBarChart = {
  ...
  key: 'MixBarChart',
  title: 'Gráfico de barras de mezclado',
  width,
  height,
  colors,
  datas: [
...
const CustomShapeBarChart = {
  ...
  title: 'Gráfico de barras de forma personalizada',
  width,
  height,
  colors,
...
const BiaxialBarChart = {
  ...
  key: 'BiaxialBarChart',
  title: 'Gráfico de barras biaxiales',
  width,
  height,
  colors,
  datas,
...
const LineBarAreaComposedChart = {
  ...
  title: 'Gráfico compuesto de área de barra de línea',
  width,
  height,
  colors,
  datas,
...
const CustomActiveShapePieChart = {
  ...
  title: 'Gráfico circular de forma activa personalizado',
  width: 600,
  height,
  colors,
  dataKey: 'value',
...
const SpecifiedDomainRadarChart = {
  ...
  title: 'Gráfico de radar de dominio especificado',
  width: 600,
  height: 500,
  colors,
  angle: 30,
...
const SimpleRadialBarChart = {
  ...
  title: 'Gráfico de barras radiales simples',
  width: 600,
  height: 300,
  datas: [
